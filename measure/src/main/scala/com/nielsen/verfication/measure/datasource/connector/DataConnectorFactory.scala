...
under the License.
*/
package com.nielsen.verfication.measure.datasource.connector
...
import com.nielsen.verfication.measure.datasource.connector.batch.{AvroBatchDataConnector, BatchDataConnector, BatchDataConnectorContext, HiveBatchDataConnector, TextDirBatchDataConnector}
import com.nielsen.verfication.measure.datasource.connector.streaming.{KafkaStreamingDataConnector, KafkaStreamingStringDataConnector, StreamingDataConnector, StreamingDataConnectorContext}

import scala.util.Try
import org.apache.spark.sql.SparkSession
import org.apache.spark.streaming.StreamingContext
import com.nielsen.verfication.measure.datasource.connector.batch._
import com.nielsen.verfication.measure.datasource.connector.streaming._
  ...
  def getDataConnector(sparkSession: SparkSession,
    ...
    Try {
      conType match {
        ...
        case ExpectRegex() => ExpectDataConnector(sparkSession, dcParam, tmstCache)
