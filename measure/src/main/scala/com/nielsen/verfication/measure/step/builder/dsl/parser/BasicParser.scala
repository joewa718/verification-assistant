...
under the License.
*/
package com.nielsen.verfication.measure.step.builder.dsl.parser

import com.nielsen.verfication.measure.step.builder.dsl.expr
import com.nielsen.verfication.measure.step.builder.dsl.expr.{AllFieldsSelectExpr, AllSelectHeadExpr, BetweenExpr, BinaryLogicalExpr, BinaryMathExpr, CombinedClause, DataSourceHeadExpr, Expr, ExtraConditionExpr, FieldNameHeadExpr, FieldSelectExpr, FromClause, FunctionExpr, FunctionSelectExpr, GroupbyClause, HeadExpr, InExpr, IndexSelectExpr, IsNanExpr, IsNullExpr, LikeExpr, LimitClause, LiteralBooleanExpr, LiteralExpr, LiteralNanExpr, LiteralNullExpr, LiteralNumberExpr, LiteralStringExpr, LiteralTimeExpr, LogicalExpr, LogicalFactorExpr, MathExpr, MathFactorExpr, OrderItem, OrderbyClause, OtherHeadExpr, RLikeExpr, SelectClause, SelectExpr, SelectionExpr, SortbyClause, UnaryLogicalExpr, UnaryMathExpr, WhereClause}
...
//    def FieldName: Parser[String] = UnQuoteTableFieldName | SimpleTableFieldName
  ...
  def selectClause: Parser[SelectClause] = opt(SELECT) ~> opt(DISTINCT) ~ rep1sep(expression, COMMA) ^^ {
    case extraCdtnOpt ~ exprs => expr.SelectClause(exprs, extraCdtnOpt.map(ExtraConditionExpr(_)))
  }
