...
under the License.
*/
package com.nielsen.verfication.measure.context
...
import com.nielsen.verfication.measure.configuration.enums.{BatchProcessType, ProcessType, StreamingProcessType, WriteMode}
...
case class DQContext(contextId: ContextId,
  ...
  private def printTimeRanges(): Unit = {
    if (dataSourceTimeRanges.nonEmpty) {
      ...
      info(s"data source timeRanges: ${timeRangesStr}")
    }
  }
